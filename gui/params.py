import PySimpleGUI as sg  # передача импорта в файлы windows.py и layouts.py
...
table_setting = {
    ...
    'justification': 'left',
    # 'num_rows': 10,
    'alternating_row_color': ALTERNATIVE_BACKGROUND_COLOR,
...
tree_setting = {
    ...
    'header_font': '_ 9',
    'header_border_width': 1,
    # header_relief: Optional[str] = None,
    # num_rows: int = None,
